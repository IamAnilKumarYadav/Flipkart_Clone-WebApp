...
const Connection = async (username, password) => {
    const URL = `mongodb://${username}:${password}@ac-oozx09b-shard-00-00.ritmj3e.mongodb.net:27017,ac-oozx09b-shard-00-01.ritmj3e.mongodb.net:27017,ac-oozx09b-shard-00-02.ritmj3e.mongodb.net:27017/?ssl=true&replicaSet=atlas-k9rtiw-shard-0&authSource=admin&retryWrites=true&w=majority`;
